...
public class DriverLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        driverUsername = (TextView) findViewById(R.id.driverUsername);
        driverUsername.setText("User : " + ParseUser.getCurrentUser().getUsername().toString());


        usernameText = (TextView) findViewById(R.id.usernameTextview);
        usernameText.setText("requester : " + intent.getStringExtra("username"));
        usernameText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(DriverLocationActivity.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
